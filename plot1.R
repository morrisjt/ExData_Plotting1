...
dev.new()
dev.copy(png,file='plot42.png',width=480,height=480)
hist(as.numeric(as.character(df$Global_active_power)),main='Global Active Power', col='red',xlab="Global Active Power (kilowatts)")
dev.off
