...
plot(df$timestamp,as.numeric(as.character(df$Voltage)),type='l',xlab='datetime',ylab="Voltage")
...
plot(df$timestamp,as.numeric(as.character(df$Global_reactive_power)),type='l',xlab='datetime',ylab="Global_reactive_power")
dev.off()
